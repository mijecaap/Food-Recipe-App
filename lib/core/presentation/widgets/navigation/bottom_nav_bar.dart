...
class BottomNavBar extends StatefulWidget {
  ...
  BottomNavBar({required this.onTapTapped, required this.indexTap, super.key});
                ...
                children: <Widget>[
                  GestureDetector(
                      ...
                      child: Material(
                        ...
                        child: CircleAvatar(
                          radius: 20.0,
                          backgroundColor: widget.indexTap == 0
                              ? AppColor.lila_1_8ff
                              : AppColor.gris_2_df2,
                          child: Icon(
                            Icons.home,
                            color: widget.indexTap == 0
                  ...
                  GestureDetector(
                      ...
                      child: Material(
                        ...
                        child: CircleAvatar(
                          radius: 20.0,
                          backgroundColor: widget.indexTap == 2
                              ? AppColor.lila_1_8ff
                              : AppColor.gris_2_df2,
                          child: Icon(
                            Icons.person,
                            color: widget.indexTap == 2
                                ? AppColor.morado_2_347
                                : AppColor.gris_5_d79,
                          ),
                        ),
