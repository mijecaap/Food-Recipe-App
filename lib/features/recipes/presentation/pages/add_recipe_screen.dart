...
class _AddRecipeScreenState extends State<AddRecipeScreen> {
  List<TextEditingController> listControllerIngredient = [
    TextEditingController()
  ];
  late List<IngredientWidget> listDynamicIngredient = [
    IngredientWidget(listControllerIngredient[0])
  ];
  ...
  addIngredient() {
    ...
    listDynamicIngredient.add(IngredientWidget(
        listControllerIngredient[listControllerIngredient.length - 1]));
    setState(() {});
  }
    ...
    Future<void> addRecipe() async {
      ...
      return recipe
          .add({
            ...
            'person': _controllerPersonRecipe.text,
            'estimated_time': _controllerTimeRecipe.text,
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                      Color(0xff990000).withOpacity(0.8), BlendMode.modulate),
                  fit: BoxFit.cover)),
        ),
        Scaffold(
            extendBody: true,
              ...
              children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.only(
                                ...
                                bottomRight:
                                    Radius.circular(screenHeight / 96))),
                        child: image != null
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius:
                                BorderRadius.circular(screenHeight / 24),
                          ),
                          child: Material(
                ...
                Padding(
                  padding: EdgeInsets.only(
                      left: screenHeight / 48, right: screenHeight / 48),
                  child: InputText(
                      hintText: "Title",
                      maxLines: 1,
                      maxLength: 15,
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: GestureDetector(
                            ...
                            child:
                                Icon(Icons.delete, color: AppColor.thirdyColor),
                          ),
                        ),
                      ],
                    ),
                ...
                Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        "+ Ingredient",
                        style:
                            GoogleFonts.openSans(color: AppColor.thirdyColor),
                      ),
                    )),
                SizedBox(height: screenHeight / 96),
                Padding(
                ...
                Padding(
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      ...
                      final isEmptyIg = listControllerIngredient
...
class IngredientWidget extends StatelessWidget {
  ...
  const IngredientWidget(this.controller, {super.key});
